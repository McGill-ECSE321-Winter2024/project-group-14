<template>
    ...
    //     </div> -->
        <el-dialog title="Create New Sport Class" :visible.sync="userFormVisible" width="30%" align="center">
            <el-form :model="form" label-width="120px" style="padding-right: 50px" :rules="rules" ref="ref">
                <el-form-item label="Name:" prop="name" >
                    <el-input v-model="form.name" placeholder="name"></el-input>
                </el-form-item>
                <el-form-item label="Confirm Name:" prop="name">
                    <el-input v-model="form.confirmName" placeholder="confirm name"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
      ...
      methods:{
        ...
        save() {
            ...
            const confirmName = this.form.confirmName;
        ...
        open(row) {
            ...
            if (this.row.approved === "true") {
                this.$message({
                    type: 'warning',
                    message: 'This class is already approved'
                });
                return;
            };
