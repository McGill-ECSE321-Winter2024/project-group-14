...
public class CustomerIntegrationTest {
	...
	public void clearDatabase() {
		CrudRepository<Customer, Integer> customerRepository;
    ...
    public void testCreateInvalidCustomer() {
        // Set up
        CustomerRequestDto request = new CustomerRequestDto(VALID_USERNAME, VALID_EMAIL, INVALID_PASSWORD);
