...
// private static Session VALID_SESSION = new Session(VALID_SESSION_START_TIME,
// VALID_SESSION_END_TIME,
// VALID_SESSION_LOCATION, VALID_SESSION_DATE, (Instructor) VALID_INSTRUCTOR,
// VALID_SPORT_CLASS);
...
// RegistrationDTO(VALID_REGISTRATION_DATE, VALID_CUSTOMER,
// VALID_SESSION);
...
// assertEquals(((CustomerDTO)
// registrationDTO.getAccount()).getCustomerUsername(),
...
// String url = "/registration/" + this.VALID_CUSTOMER + "/" +
// this.VALID_SESSION + "/";

// ResponseEntity<RegistrationDTO> response = client.getForEntity(url,
...
// assertEquals(VALID_CUSTOMER_NAME, ((CustomerDTO)
// registrationDTO.getAccount()).getCustomerUsername());
// assertEquals(VALID_SPORT_CLASS_NAME,
// (registrationDTO.getSession()).getSportClass().getName());
// assertEquals(VALID_INSTRUCTOR_NAME,
// (registrationDTO.getSession()).getInstructor().getUsername());
// }
...
// new Customer(INVALID_CUSTOMER_USERNAME, VALID_CUSTOMER_EMAIL,
// VALID_CUSTOMER_PASSWORD),
// VALID_SESSION);
...
// assertEquals("Account username can not be null or empty",
...
// assertEquals("No account with the given username exists.",
